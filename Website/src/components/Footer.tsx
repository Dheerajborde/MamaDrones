...
function Footer({ language }: FooterProps): JSX.Element {
  ...
  const content = {
    en: {
      ...
      office: "Office",
      address:
        "Mama Drone,STPI, T-17, Opp. Garware Stadium, MIDC, Chikalthana, Chhatrapati Sambhajinagar, Maharashtra 431008",
      about:
    ...
    mr: {
      ...
      office: "कार्यालय",
      address:
        "मामा ड्रोन, एस टी पी आय, टी-१७, चिकलठाणा एम.आय.डी.सी., छत्रपती संभाजीनगर, महाराष्ट्र 431008",
      about:
      ...
      <footer className="bg-green-700 text-white flex flex-col md:flex-row justify-between items-start md:items-start w-full px-6 md:px-20 py-12 md:py-16 gap-10 md:gap-6">
        ...
        >
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            <span className="font-bold">
              {language === "en" ? "Ph:" : "भा.क्र.:"} 9322418319
            </span>
          </p>
        </motion.div>
